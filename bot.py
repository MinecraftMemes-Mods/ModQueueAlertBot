...
try:
    while True:
        ...
        if modqueue_length > second_alert:
            send_message(f"<@&{modrole}>, the [modqueue](<https://reddit.com/r/{subreddit}/about/modqueue>) length has exceeded {second_alert} (currently at {modqueue_length}! Someone go check it out urgently!")
